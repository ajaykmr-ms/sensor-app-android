...
static const char* kTAG = "platform";
TickContext g_ctx;
void *g_platform_context;

JNIEXPORT jstring JNICALL
Java_com_example_sensorapp_MainActivity_stringFromJNI( JNIEnv* env, jobject thiz )
{
#if defined(__arm__)
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass  clz = (*env)->FindClass(env,
                                    "com/example/sensorapp/JniHandler");
...
void sendSensorMsg(void *context, float x, float y, float z)
{
    ...
    (*env)->CallVoidMethod(env, pctx->mainActivityObj, statusId, x, y, z);
...
Java_com_example_sensorapp_MainActivity_startTicks(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_sensorapp_MainActivity_StopTicks(JNIEnv *env, jobject instance) {
